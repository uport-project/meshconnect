...
module.exports = {
  ...
  entry: {
    app: [
      require.resolve('./polyfills'), require.resolve("babel-polyfill"), paths.appIndexJs
    ],
    assets: ["assets",],
    react: [
      "styled-components", "styled-system", "styled-theme",
      'recompose',
      'redux-saga', 'redux-form',
      ],
    vendor: ["lodash", "material-ui"],
  },
  output: {
    path: paths.appBuild,
