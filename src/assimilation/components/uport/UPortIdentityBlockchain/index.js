...
<Box {...props.styledCard}>
  ...
  <Box py={20} >
    ...
    <Box pl={[null,null,25]} >
      ...
      <Paragraph f={[1]}>
        Email: {idx(props, _=>_.data.email)}
      </Paragraph>
      <Paragraph f={[1]}>
        Phone: {idx(props, _=>_.data.phone)}
      </Paragraph>
      <Paragraph f={[1]}>
        Country: {idx(props, _=>_.data.country)}
      </Paragraph>
    </Box>
  </Flex>
  ...
  <Paragraph f={[1]}>
    <strong>MNID:</strong> {idx(props, _=>_.data.address)}
  </Paragraph>
  <Paragraph f={[1]}>
    <strong>Address:</strong> {idx(props, _=>_.data.addressDecoded.address)}
  </Paragraph>
  <Paragraph f={[1]}>
    <strong>NetworkID:</strong> {idx(props, _=>_.data.addressDecoded.network)}
  </Paragraph>
  </Box>
</Box>
