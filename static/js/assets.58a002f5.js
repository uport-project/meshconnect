...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};/* ------------------------- Internal Dependencies -------------------------- */var _images=__webpack_require__(385);var _images2=_interopRequireDefault(_images);var _graphics=__webpack_require__(604);var _graphics2=_interopRequireDefault(_graphics);var _icons=__webpack_require__(609);var _icons2=_interopRequireDefault(_icons);var _svg=__webpack_require__(612);var _svg2=_interopRequireDefault(_svg);var _devices=__webpack_require__(615);var _devices2=_interopRequireDefault(_devices);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var assets={devices:_extends({},_devices2.default),graphics:_extends({},_graphics2.default),images:_extends({},_images2.default),icons:_extends({},_icons2.default),svg:_extends({},_svg2.default)};exports.default=assets;module.exports=exports['default'];
...
"use strict";
var req=__webpack_require__(602);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(jpg|jpeg|png)/,'$1');module.exports[fileName]=req(key);});
...
module.exports = __webpack_require__.p + "static/media/gitcoin.96a42c8b.png";
...
"use strict";
var req=__webpack_require__(605);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(jpg|jepg|png)/,'$1');module.exports[fileName]=req(key);});
...
var map = {
	"./graphics/logo.png": 606,
	"./graphics/logoUport.png": 607,
	"./graphics/logoUportSmall.png": 608
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
...
module.exports = __webpack_require__.p + "static/media/logoUport.d1ac25e7.png";
...
module.exports = __webpack_require__.p + "static/media/logoUportSmall.d1ac25e7.png";
...
"use strict";
var req=__webpack_require__(610);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(svg)/,'$1');module.exports[fileName]=req(key);});
...
"use strict";
var req=__webpack_require__(613);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(svg)/,'$1');module.exports[fileName]=req(key);});
...
"use strict";
var req=__webpack_require__(616);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(jpg|jepg|png)/,'$1');module.exports[fileName]=req(key);});
...
//# sourceMappingURL=assets.58a002f5.js.map