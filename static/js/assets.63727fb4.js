...
"use strict";
var req=__webpack_require__(611);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(svg)/,'$1');module.exports[fileName]=req(key);});
...
"use strict";
var req=__webpack_require__(601);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(jpg|jpeg|png)/,'$1');module.exports[fileName]=req(key);});
...
"use strict";
var req=__webpack_require__(604);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(jpg|jepg|png)/,'$1');module.exports[fileName]=req(key);});
...
var map = {
	"./graphics/logo.png": 605,
	"./graphics/logoUport.png": 606,
	"./graphics/logoUportSmall.png": 607
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
...
"use strict";
var req=__webpack_require__(609);req.keys().forEach(function(key){var fileName=key.replace(/^.+\/([^/]+)\.(svg)/,'$1');module.exports[fileName]=req(key);});
...
//# sourceMappingURL=assets.63727fb4.js.map